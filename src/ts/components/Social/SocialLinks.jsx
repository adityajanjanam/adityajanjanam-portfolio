...
export const SocialLinks = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed left-6 bottom-0 flex flex-col items-center space-y-6 z-50"
    >
        ...
        {socialLinks.map((social, index) => (
          <motion.a
            ...
            className={`text-gray-400 ${social.color} transition-all duration-300 
              bg-gray-900/50 backdrop-blur-sm p-2.5 rounded-lg 
          ...
          >
            {social.icon}
            <span
              className="absolute left-full ml-2 px-2 py-1 bg-gray-800 text-xs rounded-md
