...
export const Contact: React.FC<ContactProps> = ({ isDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className={`text-3xl sm:text-4xl font-bold ${isDarkMode ? "text-yellow-400" : "text-yellow-600"} mb-3`}
        >
          Contact Me
        </h2>
        <p
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {status === "success" && (
            <p
              className={`text-center ${isDarkMode ? "text-green-400" : "text-green-600"}`}
            >
          ...
          {status === "error" && (
            <p
              className={`text-center ${isDarkMode ? "text-red-400" : "text-red-600"}`}
            >
