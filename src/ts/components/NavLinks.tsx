...
const NavLinks: React.FC<NavLinksProps> = ({
  ...
  // Extract aria-expanded value to avoid accessibility checker false positive
            ...
            <div className="flex items-center space-x-4 md:space-x-6">
              {navItems.map((item) => (
                <button
                  ...
                  onKeyDown={(e) =>
                    handleKeyDown(e, () => onSectionChange(item.id))
                  }
              ...
              <button
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${activeSection === "contact" ? "bg-indigo-600 text-white" : "text-gray-400 hover:text-white"}`}
