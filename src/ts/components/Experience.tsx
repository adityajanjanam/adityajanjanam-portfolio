              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                  <div>
                    ...
                    <p
                      className={`text-lg ${currentMode ? "text-gray-300" : "text-gray-700"}`}
                    >
                      {exp.company}
                    </p>
                    <p
                      className={`${currentMode ? "text-gray-400" : "text-gray-600"}`}
                    >
                ...
                <div className="mt-6">
                  ...
                  <div className="space-y-3">
                    {exp.description.map((desc: string, idx: number) => (
                      ...
                      >
                        <span
                          className={`${currentMode ? "text-yellow-400" : "text-yellow-600"} mt-1`}
                        >
                          •
                        </span>
                        <span
