...
export const Experience = () => (
  <section className="py-20 px-4 max-w-7xl mx-auto">
    <h2 className="text-3xl sm:text-4xl font-bold text-purple-400 text-center mb-10">
      Experience
    </h2>
    <div className="space-y-6">
      {experiences.map((exp, i) => (
        <div
          key={i}
          className="relative p-6 rounded-2xl overflow-hidden group bg-[#1a1a1a] border-gray-700 hover:border-gray-600 transition-all duration-300"
        >
