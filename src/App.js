...
const experiences = [
  ...
  {
    title:
      "Associate Software Engineer | Data Analyst Intern | Data Science Training",
    company: "Tech Mahindra",
    date: "May 2021 – Jul 2021",
    location: "Chennai, India",
    description: [
      "Successfully completed a 3-month internship in Data Science, focusing on Data Analytics.",
      "Acquired hands-on experience in completing courses and certifications as per the curriculum, ensuring timely submission to the Reporting Manager.",
      "Analyzed data and provided insights using various tools as part of the internship training.",
    ],
    skills: [
      "Microsoft Office",
      "Microsoft Power BI",
  ...
  {
    title:
      "Software Engineer Intern | QA Analyst | Manual & Automation Testing | Selenium Specialist",
    company: "Capgemini",
    date: "Sep 2020 – Dec 2020",
    location: "Bengaluru, India",
    description: [
      "Conducted Manual Testing and Automation Testing for websites, ensuring the delivery of high-quality software solutions.",
      "Designed and executed test cases, and created detailed defect reports for a wide range of test scenarios.",
      "Utilized the Selenium tool to automate test scripts and validated functionality, performance, and compatibility across different browsers and devices.",
      "Collaborated closely with developers to report, track, and resolve defects, ensuring favorable test outcomes and continuous improvement.",
    ],
    skills: [
      "Postman API",
      "Microsoft Office",
