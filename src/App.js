...
const BriefSummary = ({ isDarkMode }) => (
  ...
  >
    ...
    <div className="relative z-10">
      ...
      >
        <b>Full Stack Web & Mobile Apps Developer</b> with <b>3+ years</b> of hands on expertise architecting and deploying robust, user centric solutions across web, mobile, and desktop platforms. I combine deep technical mastery in <b>React, Node.js, Flutter, and cloud native technologies</b> with proven experience in enterprise IT infrastructure, DevOps, and enterprise application packaging enabling seamless delivery from code to production.<br /><br />
        <b>Academic Excellence & Technical Foundation:</b> Distinction in Computer Applications Development (Conestoga College, Waterloo, CA) | First Class in Mobile Applications Development (Centennial College, Toronto, CA) | Bachelor's in Electronics & Communication Engineering (Sathyabama Institute of Science and Technology, Chennai, India)<br /><br />
        <b>Enterprise Experience:</b> At Atos, I engineered mission critical enterprise deployments, mastering advanced software distribution through MSI/MSIX packaging, PowerShell automation, and enterprise management platforms (SCCM/Intune). I optimized deployment strategies across virtualized infrastructure including Citrix, VMware, and Hyper V ensuring 99.9% delivery success rates at scale.<br /><br />
        <b>Full Stack & Product Development:</b> During my internships at Capgemini and Tech Mahindra, I accelerated my expertise in the MERN stack, designing scalable RESTful APIs, implementing responsive UI/UX solutions, and driving projects from concept to production within Agile frameworks. I've developed a deep appreciation for code quality, performance optimization, and collaborative problem solving.<br /><br />
        <b>Core Competencies:</b> Frontend (React, React Native, Flutter, Electron) | Backend (Node.js, Express, RESTful APIs, Microservices) | Cloud & DevOps (Firebase, Vercel, Netlify) | Enterprise Tools (PowerShell, SCCM, Intune, MSI/MSIX packaging)<br /><br />
        <b>What Drives Me:</b> I'm passionate about bridging the gap between development and deployment architecting solutions that delight end-users while scaling efficiently in production. Whether building feature rich web apps, cross-platform mobile solutions, or streamlining enterprise software delivery, I focus on delivering measurable business value through clean code, thoughtful design, and strategic implementation.<br /><br />
        <b>Open to Opportunities:</b> Full Stack Development | Mobile App Development (React Native, Flutter, iOS/Android) | Desktop Applications (Electron) | Enterprise Application Packaging & Deployment | Cloud Architecture | DevOps Engineering
      </motion.div>
    </div>
