...
const BriefSummary = ({ isDarkMode }) => (
  ...
  >
    ...
    <div className="relative z-10">
      ...
      >
        <b>Innovative Full Stack & Mobile Developer</b> with <b>3+ years</b> of hands-on expertise architecting and deploying robust, user-centric solutions across web, mobile, and desktop platforms. I combine deep technical mastery in <b>React, Node.js, Flutter, and cloud-native technologies</b> with proven experience in enterprise IT infrastructure, DevOps, and enterprise application packaging—enabling seamless delivery from code to production.<br /><br />
        <b>Academic Excellence & Technical Foundation:</b> Distinction in Computer Applications Development (Conestoga College, Waterloo) | Distinction in Mobile Applications Development (Centennial College, Toronto) | Bachelor's in Electronics & Communication Engineering (Sathyabama Institute of Science and Technology, Chennai, India)<br /><br />
        ...
        <b>Core Competencies:</b> Frontend (React, React Native, Flutter, Electron) | Backend (Node.js, Express, RESTful APIs, microservices) | Cloud & DevOps (Firebase, Azure, AWS, Docker, Kubernetes) | Enterprise Tools (PowerShell, SCCM, Intune, MSI/MSIX packaging)<br /><br />
